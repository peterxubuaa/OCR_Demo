package com.min.baiduai.demo.baidu.speech;
...
import com.min.baiduai.demo.baidu.speech.listener.RecogEventAdapter;
...
public class Recognizer {
     ...
     */
    public Recognizer(Context context, IRecogListener recogListener) {
     ...
     *
     * @param mEventListener 识别状态和结果回调
     */
    private Recognizer(Context context, EventListener mEventListener) {
        if (mIsInited) {
