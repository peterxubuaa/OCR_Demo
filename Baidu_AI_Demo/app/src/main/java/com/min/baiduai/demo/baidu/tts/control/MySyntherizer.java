package com.min.baiduai.demo.baidu.tts.control;
...
import com.min.baiduai.demo.baidu.tts.MainHandlerConstant;
...
public class MySyntherizer implements MainHandlerConstant {
    ...
    public MySyntherizer(Context context, Handler mainHandler) {
        if (isInitied) {
