package com.min.baiduai.demo.baidu.tts.listener;

import android.os.Handler;
import android.os.Message;
import android.util.Log;

import static com.min.baiduai.demo.baidu.tts.MainHandlerConstant.PRINT;
import static com.min.baiduai.demo.baidu.tts.MainHandlerConstant.UI_CHANGE_INPUT_TEXT_SELECTION;
import static com.min.baiduai.demo.baidu.tts.MainHandlerConstant.UI_CHANGE_SYNTHES_TEXT_SELECTION;
